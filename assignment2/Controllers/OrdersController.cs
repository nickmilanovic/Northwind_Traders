...
namespace assignment2.Controllers
{
    public class OrdersController : Controller
    {
        ...
        // GET: Orders
        public async Task<IActionResult> Index(int? pageNumber, int? ordersPerPage)
        {
            ViewBag.OrdersPerPage = ordersPerPage;
            var orders = from o in _context.Orders
                         ...
                         select o;
            return View(await PaginatedList<Order>.CreateAsync(orders.AsNoTracking(), pageNumber ?? 1, ordersPerPage ?? 5));
        }
